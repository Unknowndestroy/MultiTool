...
GITHUB_REPO = 'https://api.github.com/repos/Unknowndestroy/MT-Source/contents/'
BRANCH = 'main'
STARTUP_NAME = 'MT-Updater.lnk'
...
def add_to_startup():
    try:
        ...
        shortcut.Description = "MultiTool Otomatik Güncelleyici"
        shortcut.save()
    except Exception as e:
...
class UpdateGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("MultiTool Güncelleyici")
    ...
    def create_widgets(self):
        self.header = ttk.Label(self, text="MultiTool Otomatik Güncelleme", font=("Arial", 14, "bold"))
